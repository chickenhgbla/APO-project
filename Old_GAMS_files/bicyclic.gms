Set
    ...
    g 'group type'                      /  CH3, CH2, CH, C, CH2--CH, CH--CH, CH2--C, CH--C, C--C,
                                           ...
                                           ACH, AC, ACCH3, ACCH2, ACCH, ACOH, CCl, ACF /
...
CCl        3       1    2.2073 11.3959 0.0031  0.716  9.818    29.1848     52.3817     -30.8526
ACF        2       3    0.9442 2.8977  0.0130  0.263  4.877    30.1696     26.9738     -13.3722
...
Equation
    ...
    M_eq   Relate mo to binary molecule types
...
octet..       sum(g, (2-info(g,'v'))*n(g)) - 2*mo =E= 0;
